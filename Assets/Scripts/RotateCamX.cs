...
public class RotateCamX : MonoBehaviour
{
    //Inicializamos el objeto a rotar y el slider que lo va a controlar.
    ...
    void OnSliderChanged(float value)
    {
        ...
        this.ObjetoRotar.transform.Rotate(Vector3.right * delta * 360);
